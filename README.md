        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(224, 36, 183);
            ...
            form {
                ...
                height: 40px;
                display: flex;
                background: rgba(16, 201, 238, 0.2);
                padding: 1px 1px;
                font-size: 15px;
                border-radius: 10px;
            ...
            .login:hover {
                border: 2px solid rgb(227, 176, 35);
                color: rgb(216, 17, 100);
            ...
            .signup {
                margin: 0px 10px;
                border: 2px solid rgb(158, 232, 10);
                padding: 13px 35px;
                letter-spacing: 1px;
                color:black;
                border-radius: 30px;
                background-color:  rgb(241, 22, 161);
                text-decoration: none;
            }
            .signup:hover {
                border: 2px solid rgb(23, 69, 217);
                color: rgb(17, 226, 167);
                background-color: white;
                transition: 0.5s;
                cursor: pointer;
            }
            footer {
                background-color: rgb(81, 230, 21);
                margin-top: auto;
            }
        </style>
    </head>
<body>
    ...
    <footer>
        <center> Designed and Developed by S.KEERTHIVASAN(212222040076)</center>
    </footer>
</body>
</html>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(44, 98, 178);
                background-size: cover;
                background-position: center;
            }
            .navbar {
...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">DAS <span>N </span>CO<span></span></h1>
            <ul>
                <li><a href="home.html"> Home </a></li>
                <li><a href="Product.html"> Products </a></li>
                <li><a href="people.html"> People </a></li>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(62, 219, 138);
                background-size: cover;
                background-position: center;
            }
            .navbar {
...
<body>
    <div class="banner">
        <br>
        <div class="navbar">
            <h1 class="logo">DAS <span>N </span>C<span>O</span></h1>
            <ul>
                <li><a href="home.html"> Home </a></li>
                <li><a href="Product.html"> Products </a></li>
                <li><a href="people.html"> People </a></li>
        ...
        <div class="image">
            <table cellspacing="20"> 
                <tr align="center">
                    <td> <img src="IMG_1293.JPG"> </td>
                    <td> <img src="ronaldo.jpeg"> </td>
                    <td> <img src="vijay.jpeg"> </td>
                    <td> <img src="samantha.jpeg"> </td>
                    <td> <img src="ben 10.jpeg"> </td>
                    <td> <img src="ttf vasan.jpeg"> </td>
                </tr>
                <tr align="center">
                    <th> S.KEETHIVASAN </th>
                    <th> RONALDO </th>
        ...
        <style type="text/css">
            * {
            ...
            .banner {
                width: 100%;
                height: 100vh;
                background-color:rgb(213, 13, 210);
                background-size: cover;
                background-position: center;
            }
            .navbar {
...
<body>
    <div class="banner">
        ...
        <div class="box">
            ...
            <div class="box-2"> 
                <h2> CONTACT INFO </h2>
                <p> <span>Address</span> : N4,TEACHERS COLONY SHENOY NAGAR</p>
                <p> <span>Email</span> : DAS N CO@gmail.com.com </p>
                <p> <span>Phone</span> : 9946516492 </p>
            </div>
        </div>
    </div>
    <footer>
